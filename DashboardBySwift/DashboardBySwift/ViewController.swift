...
//  DashboardBySwift
//
//  Created by bc-mac-黄永强 on 2016/12/29.
...
class ViewController: UIViewController {
    ...
    func drawProgressLayer() {
        ...
        let intArc = self.drawCurve(Radius: 82.5)
        view.layer.addSublayer(outArc)
        view.layer.addSublayer(intArc)
        ...
        view.layer.addSublayer(progressLater!)
    }
    ...
    @IBAction func sliderAction(_ sender: UISlider) {
        progressLater?.strokeEnd = CGFloat(sender.value)
